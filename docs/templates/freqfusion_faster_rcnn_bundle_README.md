...
Este directorio reúne **solo los archivos imprescindibles** para
entrenar o evaluar Faster R-CNN con el cuello `FreqFusionCARAFEFPN` sobre COCO. Puedes
trabajar únicamente con este paquete y eliminar el resto del repositorio si tu interés
se centra en esta configuración.

## Contenido principal

- `mmdet/`: subconjunto curado de MMDetection v2.28.1 con los módulos estrictamente
  necesarios para Faster R-CNN (backbone ResNet, FPN/FreqFusion, RPN, ROI head, pérdidas,
  pipelines de datos y utilidades básicas).
